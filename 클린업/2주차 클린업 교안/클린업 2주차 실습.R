...
#해석
summary(baseline_model)$coefficients %>% exp()
# mpg가 1단위 증가할때 Y=3 대신 Y=4일 오즈가 1.61배 만큼 증가
# mpg가 1단위 증가할때 Y=3 대신 Y=5일 오즈가 1.43배 만큼 증가
#해석해보세요!
...
#해석
summary(baseline_model2)$coefficients %>% exp()
# mpg가 1단위 증가할 때 Y=1 대신 Y=2일 오즈가 0.9배만큼 증가
# mpg가 1단위 증가할 때 Y=1 대신 Y=3일 오즈가 0.6배만큼 증가
# mpg가 1단위 증가할 때 Y=1 대신 Y=4일 오즈가 0.57배만큼 증가
# mpg가 1단위 증가할 때 Y=1 대신 Y=6일 오즈가 0.79배만큼 증가
# mpg가 1단위 증가할 때 Y=1 대신 Y=8일 오즈가 0.53배만큼 증가
...
#해석
#mpg가 1단위 증가할 때 Y>4에 비해 Y<=4일 오즈가 약 5.63배만큼 증가
#비례오즈 가정으로 Y>6에 비해 Y<=6일 오즈도 약 5.63배만큼 증가
#해석해보세요!
